...
# we can get similar visualization if we add a third section
camera1 = camera_cut_track.sequencer_track_add_section()
camera2 = camera_cut_track.sequencer_track_add_section()
camera3 = camera_cut_track.sequencer_track_add_section()
...
camera1.CameraBindingID = MovieSceneObjectBindingID( Guid=ue.string_to_guid( camera2_guid ), Space=EMovieSceneObjectBindingSpace.Local )
camera2.CameraBindingID = MovieSceneObjectBindingID( Guid=ue.string_to_guid( camera_guid ), Space=EMovieSceneObjectBindingSpace.Local )
camera3.CameraBindingID = MovieSceneObjectBindingID( Guid=ue.string_to_guid( camera2_guid ), Space=EMovieSceneObjectBindingSpace.Local )

camera1.sequencer_set_section_range(0.5, 3.5)
camera2.sequencer_set_section_range(3.5, 5)
camera3.sequencer_set_section_range(5, 17)
