...
#include "PythonGeneratedClass.generated.h"

// Huge thanks to Unreal.js project, for showing how to expose a native class

UCLASS()
class UPythonGeneratedClass : public UBlueprintGeneratedClass
{
	GENERATED_BODY()
